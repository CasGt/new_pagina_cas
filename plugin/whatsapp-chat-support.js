 ...
 * ====================================================================== */    
    ...
    WhatsappChatSupport.DEFAULTS = {
        ...
        timezone                    :   'America/Guatemala', // When using the date and time from the user browser you can transform it to your current timezone (in case your user is in a different timezone)
        notAvailableMsg             :   'Estaremos disponible pronto', // message when its not an available day or once the available hours have passed
        almostAvailableMsg          :   'Estaré disponible pronto', // if today is an available day and before the time starts
        dialogNotAvailableMsg       :   'Estaremos disponible pronto', // message when its not an available day or once the available hours have passed
